...
from facefusion.wording_ru import WORDING as WORDING_RU
...
def set_language(lang: str) -> None:
	...
	if lang.upper() in _WORDINGS:
		_current_language = lang.upper()

def get_language() -> str:
	return _current_language

def get(notation : str) -> Optional[str]:
	current = _WORDINGS.get(_current_language, WORDING_EN)
